...
myconn = mysql.connector.connect(
    host="localhost", user="root", database="facerecognition", password="Lamcy#108")
...
class Ui_Dialog3():
    ...
    def saveCSV(self):
        ...
        if(data != []):
            ...
            fileName = f"{current_time}_{self.account}_to_transactions.csv" 
            data_df.to_csv(f"../csv_downloads/{fileName}")
        ...
        if(data != []):
            ...
            fileName = f"{current_time}_{self.account}_from_transactions.csv" 
            data_df.to_csv(f"../csv_downloads/{fileName}")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Transaction"))

        self.pushButton_1.setText(_translate("Dialog", "Save to CSV"))

        # self.b1.clicked.connect(lambda: Dialog.close())
